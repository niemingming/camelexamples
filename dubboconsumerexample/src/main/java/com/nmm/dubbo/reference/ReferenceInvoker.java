package com.nmm.dubbo.reference;
...
public class ReferenceInvoker<T> extends ReferenceConfigBase<T> {
    ...
    public ReferenceInvoker(Class interfaceClass,String version,String ... address) {
        super();
    ...
    public ReferenceInvoker(Reference reference) {
        super(reference);
        this.repository = ApplicationModel.getServiceRepository();
    }
